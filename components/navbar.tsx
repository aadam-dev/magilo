 ...
 * Uses proper URL encoding for the message parameter
 */
...
export function Navbar() {
  ...
  return (
    <header 
      className="sticky top-0 z-50 w-full border-b border-gray-100/50 bg-white/90 backdrop-blur-md supports-[backdrop-filter]:bg-white/80 transition-all duration-300"
      role="banner"
    >
      <div className="container mx-auto px-4">
        <div className="flex h-18 items-center justify-between py-4">
          ...
          >
            {/* Logo mark - decorative accent square */}
            <span 
              className="w-8 h-8 bg-gradient-to-br from-navy to-navy-light rounded-lg flex items-center justify-center transition-transform duration-300 group-hover:scale-105"
              aria-hidden="true"
            >
              <span className="text-white font-bold text-sm">M</span>
            </span>
            {/* Logo text */}
            <span className="text-2xl font-bold text-navy font-heading tracking-tight">
              Magilo
            </span>
          </Link>
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            >
              ...
              <div className="flex items-center space-x-2 mb-8">
                <span 
                  className="w-8 h-8 bg-gradient-to-br from-navy to-navy-light rounded-lg flex items-center justify-center"
                  aria-hidden="true"
                >
                  <span className="text-white font-bold text-sm">M</span>
                </span>
                <SheetTitle className="text-xl font-bold text-navy font-heading">
                  Magilo
                </SheetTitle>
              </div>
