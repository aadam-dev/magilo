...
const trustIndicators = [
  { text: "30+ Years Experience", id: "experience" },
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-200/90 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in-up animation-delay-300">
            With over 30 years in the graphic design industry, we deliver professional printing, 
            creative design, and business consulting services. 
