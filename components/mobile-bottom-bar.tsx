 ...
 * Phone contact link
 */
const phoneNumber = "tel:+233244693327";
...
export function MobileBottomBar() {
  return (
    <div 
      className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white/95 backdrop-blur-md border-t border-gray-200/80 safe-area-inset-bottom"
      role="navigation"
