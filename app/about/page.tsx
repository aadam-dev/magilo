...
export const metadata: Metadata = {
  title: "About Magilo - 30+ Years Graphic Design & Printing Excellence | Adenta, Accra Ghana",
  description: "Since 1994, Magilo has been Ghana's trusted graphic design & printing company. 30+ years serving Adenta, Accra with professional printing, web design, business consulting. Visit us in Adenta or call +233 24 469 3327.",
  keywords: [
    "about Magilo Ghana",
    "graphic design company Adenta",
    "printing company Accra",
    "30 years graphic design Ghana",
  ...
  openGraph: {
    title: "About Magilo - 30+ Years of Creative Excellence | Adenta, Accra Ghana",
    description: "Since 1994, Ghana's trusted graphic design & printing company. Visit us in Adenta, Accra.",
...
const contactInfo = [
  {
    icon: MapPin,
    title: "Visit Us",
    details: ["Adenta, Greater Accra", "P.O. Box AF 50, Adenta, Ghana"],
  },
  {
    icon: Phone,
    title: "Call Us",
    details: ["+233 24 469 3327", "+233 27 363 6222"],
  },
  {
    icon: Mail,
    title: "Email Us",
    details: ["info@magilo.com"],
  },
  {
    icon: Clock,
    title: "Working Hours",
...
/** WhatsApp contact link with general inquiry message */
const whatsappLink = "https://wa.me/233244693327?text=Hi%20Magilo,%20I%20have%20a%20question";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  With <strong>over 30 years in the graphic design industry</strong>, Magilo Art College 
                ...
                <p>
                  ...
                  schools, and individuals across Greater Accra and beyond.
                </p>
                <p>
                  Our three decades of experience have expanded our offerings to include strategic business 
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-orange text-white rounded-xl p-6 shadow-xl hidden md:block">
                <div className="text-center">
                  <span className="text-4xl font-bold font-heading">30+</span>
