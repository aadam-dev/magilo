...
export const metadata: Metadata = {
  metadataBase: new URL("https://magilo.com"),
  title: {
    default: "Magilo - 30+ Years Graphic Design, Printing & Web Development | Adenta, Accra Ghana",
    template: "%s | Magilo - Adenta, Accra Ghana",
  },
  description: "Ghana's trusted graphic design & printing company with 30+ years experience. Professional printing, web design, business plans, pitch decks in Adenta, Accra. T-shirt printing, billboards, banners, business stationery & consulting services.",
  keywords: [
    // Primary Services
    ...
    // Long-tail
    "30 years graphic design experience Ghana",
  ...
  openGraph: {
    type: "website",
    locale: "en_GH",
    url: "https://magilo.com",
    siteName: "Magilo Art College & Printing Hub",
    title: "Magilo - 30+ Years Graphic Design, Printing & Web Development | Adenta, Accra Ghana",
    description: "Ghana's trusted graphic design & printing company with 30+ years experience. Professional printing, web design, business consulting in Adenta, Accra.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Magilo Art College & Printing Hub - 30+ Years of Excellence in Ghana",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Magilo - 30+ Years Graphic Design & Printing | Adenta, Accra Ghana",
    description: "Ghana's trusted graphic design & printing company. Professional printing, web design, business consulting in Adenta, Accra.",
    images: ["/og-image.jpg"],
  },
  robots: {
    index: true,
...
const jsonLd = {
  ...
  description: "Ghana's trusted graphic design and printing company with over 30 years of experience. Offering professional printing, web design, business consulting, and vocational art training in Adenta, Accra.",
  url: "https://magilo.com",
  telephone: ["+233244693327", "+233273636222"],
  email: "info@magilo.com",
  foundingDate: "1994",
  yearEstablished: "1994",
  slogan: "30+ Years of Creative Excellence",
  image: "https://magilo.com/og-image.jpg",
  logo: "https://magilo.com/logo.png",
  priceRange: "$$",
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://magilo.com" />
