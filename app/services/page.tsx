...
export const metadata: Metadata = {
  ...
  description: "30+ years of professional printing & graphic design in Ghana. T-shirt printing, billboards, banners, web design, business plans, pitch decks, ESG assessment in Adenta, Accra. Best printing company Ghana.",
  keywords: [
  ...
  openGraph: {
    title: "Printing, Design & Business Services | 30+ Years Experience | Magilo Ghana",
    description: "Professional printing, web design, and business consulting services in Adenta, Accra. T-shirts, billboards, business plans, pitch decks and more.",
...
const serviceCategories = [
  ...
  },
  {
    ...
    description: "Strategic services backed by 30+ years of industry experience",
    icon: Briefcase,
    services: [
      {
        icon: Globe,
...
const whatsappLink = "https://wa.me/233244693327?text=Hi%20Magilo,%20I'm%20interested%20in%20your%20printing%20services";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-lg text-gray-200 mb-8">
              Backed by over three decades in the graphic design industry, we offer 
