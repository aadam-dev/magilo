...
export const metadata: Metadata = {
  ...
  description: "Ghana's premier graphic design & printing company with 30+ years experience. Professional printing services, web design, business plans, pitch decks in Adenta, Accra. T-shirt printing, billboards, banners, logo design & business consulting.",
  keywords: [
